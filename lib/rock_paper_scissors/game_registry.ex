defmodule RockPaperScissors.GameRegistry do
  use GenServer
  import Kernel, except: [send: 2]

  # based on Elixir in Action's implementation

  def get_all do
    GenServer.call(:process_registry, :get_all)
  end
  ...
  def handle_call(:get_all, _, process_registry) do
